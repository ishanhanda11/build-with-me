...
router.patch('/:id/status', authenticate, validate(updateProjectValidation), updateProjectController)
router.delete('/:id/delete', authenticate, deleteProjectController)
